...
export const metadata: Metadata = {
  title: "Maintenance",
  description: "Gestion de la maintenance du personnel municipal",
}

export default function StaffResourcesMaintenancePage() {
  return (
      ...
      <div className="flex-1 rounded-lg border border-dashed border-gray-200 p-8">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">La gestion de la maintenance sera bientôt disponible.</p>
          </div>
        </div>
      </div>
    </div>
