...
export const metadata: Metadata = {
  ...
  description: "Gestion des disponibilités du personnel municipal",
}

export default function StaffAppointmentsAvailabilityPage() {
  return (
      ...
      <div className="flex-1 rounded-lg border border-dashed border-gray-200 p-8">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">La gestion des disponibilités sera bientôt disponible.</p>
          </div>
        </div>
      </div>
    </div>
