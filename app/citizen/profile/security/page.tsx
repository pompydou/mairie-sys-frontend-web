...
export const metadata: Metadata = {
  title: "Sécurité",
  description: "Sécurité du profil de l'espace citoyen",
}

export default function CitizenProfileSecurityPage() {
  return (
      ...
      <div className="flex-1 rounded-lg border border-dashed border-gray-200 p-8">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Les paramètres de sécurité seront bientôt disponibles.</p>
          </div>
        </div>
      </div>
    </div>
