...
export const metadata: Metadata = {
  title: "Mes documents",
  description: "Mes documents de l'espace citoyen",
}

export default function CitizenDocumentsMyDocsPage() {
  return (
      ...
      <div className="flex-1 rounded-lg border border-dashed border-gray-200 p-8">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Vos documents personnels seront bientôt disponibles.</p>
          </div>
        </div>
      </div>
    </div>
