...
export const metadata: Metadata = {
  title: "Branding",
  description: "Branding des municipalités",
}

export default function AdminTenantsBrandingPage() {
  return (
      ...
      <div className="flex-1 rounded-lg border border-dashed border-gray-200 p-8">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Le branding des municipalités sera bientôt disponible.</p>
          </div>
        </div>
      </div>
    </div>
