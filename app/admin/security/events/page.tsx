...
export const metadata: Metadata = {
  ...
  description: "Événements de sécurité du système",
}
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">Événements de sécurité</h2>
      </div>
      <div className="flex-1 rounded-lg border border-dashed border-gray-200 p-8">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Les événements de sécurité seront bientôt disponibles.</p>
          </div>
        </div>
      </div>
    </div>
