...
export const metadata: Metadata = {
  title: "Debugging",
  description: "Outils de debugging du système",
}

export default function AdminMonitoringDebuggingPage() {
  return (
      ...
      <div className="flex-1 rounded-lg border border-dashed border-gray-200 p-8">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Les outils de debugging seront bientôt disponibles.</p>
          </div>
        </div>
      </div>
    </div>
