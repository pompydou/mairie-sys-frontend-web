...
export const metadata: Metadata = {
  ...
  description: "Analyses de performance du chef de service",
}

export default function ManagerReportsPerformancePage() {
  return (
      ...
      <div className="flex-1 rounded-lg border border-dashed border-gray-200 p-8">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Les analyses de performance seront bientôt disponibles.</p>
          </div>
        </div>
      </div>
    </div>
